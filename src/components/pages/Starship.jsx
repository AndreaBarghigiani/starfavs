      ...
      <div className="mx-auto flex max-w-xl flex-col items-center gap-4">
        ...
        <aside className="flex w-full justify-between gap-4">
          ...
          <div>
            ...
            <DataRow label="Manufacturer">{data.manufacturer}</DataRow>
            <DataRow label="Model">{data.model}</DataRow>
            <DataRow label="Class">{data.starship_class}</DataRow>
            <DataRow label="Max speed">{data.max_atmosphering_speed}</DataRow>
            <DataRow label="Hyperdrive rating">
